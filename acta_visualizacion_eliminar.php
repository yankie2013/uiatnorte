...
?><!doctype html><meta charset="utf-8"><body style="font:14px system-ui;padding:25px">
<?php require_once __DIR__ . '/sidebar.php'; ?>
<h1>Eliminar acta de visualizacion #<?=$id?></h1><p>Esta accion eliminara tambien sus discos, archivos y participantes seleccionados.</p><form method="post"><input type="hidden" name="id" value="<?=$id?>"><input type="hidden" name="embed" value="<?=$embed?1:0?>"><button>Eliminar</button></form></body>
