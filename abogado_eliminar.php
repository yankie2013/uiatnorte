...
<body>
<div class="wrap">
  <h1 style="margin-top:0">Eliminar abogado #<?= (int)$id ?></h1>
  <?php if($error): ?><div class="err">Error: <?= h($error) ?></div><?php endif; ?>
  <p>Se eliminara este abogado del accidente de forma permanente.</p>

  <div class="meta">
    <div class="row"><div class="lbl">Abogado</div><div class="val"><?= h($nombre !== '' ? $nombre : 'Sin nombre') ?></div></div>
    <div class="row"><div class="lbl">Colegiatura</div><div class="val"><?= h((string)($row['colegiatura'] ?? '-')) ?></div></div>
    <div class="row"><div class="lbl">Representa a</div><div class="val"><?= h($representado !== '' ? $representado : 'Sin persona asociada') ?></div></div>
  </div>
