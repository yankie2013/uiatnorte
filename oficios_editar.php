...
async function loadAsuntos(entidadId, tipo, selected=''){ const data = await fetchJSON('?ajax=asuntos&selected_id='+encodeURIComponent(selected || '')); fillSelect(asuntoSel, data.items||[], selected, 'Selecciona el asunto'); }
