...
<div class="toolbar">
  ...
  <form method="post" class="card">
    ...
    <div class="grid">
      ...
      <div class="c12" id="diligenciasSolicitadasBox" style="display:none;"><div class="preview"><h4>Informacion de diligencias solicitada</h4><label for="diligencias_solicitadas">Diligencias*</label><textarea name="diligencias_solicitadas" id="diligencias_solicitadas" placeholder="Escribe una diligencia por linea"><?= h($data['diligencias_solicitadas']) ?></textarea><div class="muted">Puedes solicitar una o varias diligencias. Escribe cada una en una linea distinta.</div></div></div>
