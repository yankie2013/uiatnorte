...
<div><label for="numero_documento">Numero de documento</label><div class="category-combobox" data-creatable-combobox data-options="<?= h(json_encode(array_values($ctx['numeros_documento']), JSON_UNESCAPED_UNICODE)) ?>"><input id="numero_documento" type="text" name="numero_documento" value="<?= h($data['numero_documento']) ?>" maxlength="100" autocomplete="off" role="combobox" aria-autocomplete="list" aria-expanded="false"></div></div>
