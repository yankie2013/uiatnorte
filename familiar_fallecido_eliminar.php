...
<title>Eliminar familiar de fallecido</title>
<style>
...
<body>
<div class="wrap">
  <h1 style="margin-top:0">Eliminar familiar de fallecido #<?= (int)$id ?></h1>
  <?php if($error): ?><div class="err">Error: <?= h($error) ?></div><?php endif; ?>
  <p>Se eliminara este registro de forma permanente.</p>

  <div class="meta">
    <div class="row"><div class="lbl">Fallecido</div><div class="val"><?= h($fallecido !== '' ? $fallecido : 'Sin fallecido') ?></div></div>
    <div class="row"><div class="lbl">Familiar</div><div class="val"><?= h($familiar !== '' ? $familiar : 'Sin familiar') ?></div></div>
    <div class="row"><div class="lbl">Parentesco</div><div class="val"><?= h((string)(($row['parentesco'] ?? '') !== '' ? $row['parentesco'] : '-')) ?></div></div>
  </div>
