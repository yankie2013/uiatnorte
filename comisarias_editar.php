...
<div class="wrap">
  ...
  <form method="post" class="card" id="frmComisaria" autocomplete="off">
    ...
    <div class="grid">
      ...
      <div class="c6 field"><label class="label">Tipo</label><input type="text" name="tipo" value="<?= h((string) $data['tipo']) ?>"></div>
      ...
      <div class="c6 field"><label class="label">Latitud</label><input type="text" name="lat" value="<?= h((string) $data['lat']) ?>"></div>
      <div class="c6 field"><label class="label">Longitud</label><input type="text" name="lon" value="<?= h((string) $data['lon']) ?>"></div>
      <div class="c12 field"><label class="label">Notas</label><textarea name="notas"><?= h((string) $data['notas']) ?></textarea></div>
    </div>
    <div class="actions">
      <div><a class="btn danger" href="comisarias_eliminar.php?id=<?= (int) $id ?>&return_to=<?= urlencode($returnTo) ?>">Eliminar</a></div>
      <div class="right"><a class="btn" href="<?= h($returnTo) ?>">Cancelar</a><button class="btn primary" type="submit">Guardar</button></div>
    </div>
  </form>
</div>
</body>
