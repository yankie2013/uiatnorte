...
<div class="wrap">
  <div class="toolbar">
    ...
    <div style="display:flex;gap:10px;flex-wrap:wrap"><button class="btn" type="button" onclick="history.back()">Volver</button><button class="btn primary" type="submit" form="frmEntidad">Guardar cambios</button></div>
  </div>
